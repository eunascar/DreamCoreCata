...
public:
    ...
    CreatureAI* GetAI(Creature* creature) const
    {
        return new npc_elder_brightleafAI (creature);
    }

    struct npc_elder_brightleafAI : public ScriptedAI
    {
        npc_elder_brightleafAI(Creature *creature) : ScriptedAI(creature)
        {
...
public:
    ...
    CreatureAI* GetAI(Creature* creature) const
    {
        return new npc_elder_ironbranchAI (creature);
    }

    struct npc_elder_ironbranchAI : public ScriptedAI
    {
        npc_elder_ironbranchAI(Creature *creature) : ScriptedAI(creature)
        {
            instance = creature->GetInstanceScript();
        }
...
public:
    ...
    CreatureAI* GetAI(Creature* creature) const
    {
        return new npc_elder_stonebarkAI (creature);
    }

    struct npc_elder_stonebarkAI : public ScriptedAI
    {
        npc_elder_stonebarkAI(Creature *creature) : ScriptedAI(creature)
        {
            instance = creature->GetInstanceScript();
        }
